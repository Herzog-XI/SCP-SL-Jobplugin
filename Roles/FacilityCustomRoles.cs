...
namespace FacilityJobs.Roles
{
    ...
    internal sealed class ZoneManagerRole : FacilityCustomRole
    {
        ...
        public override string IntroBody => "Du besitzt Zugriff auf nahezu alle Bereiche der Anlage und bist für die Koordination innerhalb der Foundation verantwortlich. Nutze deine Zugangsrechte mit Bedacht, unterstütze Wissenschaftler und Sicherheitspersonal und berücksichtige dabei auch die SCPs, die für das Überleben der Foundation entscheidend sein können.";
        public override string Description { get; set; } =
            ...
            "• Berücksichtige die SCPs als möglichen Faktor im Chaos.\n" +
    ...
    internal sealed class HausmeisterRole : FacilityCustomRole
    {
        ...
        public override string IntroTitleColor => "#F6D55C";
        public override string IntroBody => "Du hältst die Anlage am Laufen und unterstützt das Foundation-Personal. Nutze deine erweiterten Zugangsrechte, vermeide unnötige Kämpfe und bedenke, dass die SCPs im Chaos der Anlage sowohl Gefahr als auch einen möglichen Ausweg bedeuten können.";
        public override string Description { get; set; } =
            ...
            "• Bedenke die SCPs als mögliche Bedrohung oder Chance.\n" +
    ...
    internal sealed class CiAgentRole : FacilityCustomRole
    {
        ...
        public override string Description { get; set; } =
            ...
            "• Nutze die SCPs bei Bedarf als Verbündete gegen die Foundation.\n" +
    ...
    internal sealed class WraithRole : SerpentsHandCustomRole
    {
        ...
        public override string IntroTitleColor => "#FF7AD9";
        public override string IntroBody => "Du operierst aus dem Schatten und greifst die Foundation dort an, wo sie es am wenigsten erwartet. Nutze deine Spezialausrüstung, überrasche Gegner und unterstütze die SCPs, während ihr gemeinsam den Widerstand der Foundation brecht.";
        public override string Description { get; set; } = "<color=#4FA45B><b>SERPENT'S HAND — WRAITH</b></color>\n\nDu bist der Schatten zwischen den Korridoren. Deine Feinde sollen dich erst bemerken, wenn es bereits zu spät ist.\n\n<color=#A8DDB0>• Bewege dich unauffällig.\n• Überrasche isolierte Gegner.\n• Unterstütze die SCPs dort, wo der Feind verwundbar ist.\n• Arbeite mit den SCPs zusammen, um die Foundation zu schwächen.</color>\n\n<color=#79C987><i>" + Motto + "</i></color>";
    ...
    internal sealed class SeekerRole : SerpentsHandCustomRole
    {
        ...
        public override string IntroTitleColor => "#FF7AD9";
        public override string IntroBody => "Du bist auf Aufklärung und das Aufspüren von Gegnern spezialisiert. Nutze deine Mobilität und Feuerkraft, um Bedrohungen für dein Team zu beseitigen, den SCPs den Weg freizumachen und mit ihnen gemeinsam gefährliche Gegner auszuschalten.";
        public override string Description { get; set; } = "<color=#4FA45B><b>SERPENT'S HAND — SEEKER</b></color>\n\nDu bist der Jäger. Niemand, der den SCPs gefährlich werden könnte, soll der Anlage entkommen.\n\n<color=#A8DDB0>• Verfolge fliehende Gegner.\n• Kontrolliere Engpässe und Fluchtwege.\n• Entferne Bedrohungen für die SCPs.\n• Arbeite mit den SCPs beim Aufspüren und Ausschalten von Feinden.</color>\n\n<color=#79C987><i>" + Motto + "</i></color>";
    ...
    internal sealed class InfiltratorRole : SerpentsHandCustomRole
    {
        ...
        public override string IntroTitleColor => "#FF7AD9";
        public override string IntroBody => "Du bist ein vielseitiger Kämpfer und passt dich jeder Situation an. Nutze deine Ausrüstung, unterstütze deine Verbündeten und arbeite mit den SCPs zusammen, um Schwachstellen der Foundation auszunutzen und entscheidende Angriffe einzuleiten.";
        public override string Description { get; set; } = "<color=#4FA45B><b>SERPENT'S HAND — INFILTRATOR</b></color>\n\nDu bist der vielseitige Kämpfer der Einheit. Passe dich der Lage an und brich dort durch, wo die Foundation Schwäche zeigt.\n\n<color=#A8DDB0>• Kämpfe flexibel.\n• Nutze Ausrüstung und Gelände zu deinem Vorteil.\n• Unterstütze die SCPs bei ihrem Vormarsch.\n• Arbeite mit den SCPs zusammen, um entscheidende Durchbrüche zu erzielen.</color>\n\n<color=#79C987><i>" + Motto + "</i></color>";
